...
class RoleControllerx extends Controller
{
    protected $srs;
            ...
            return DataTables::of($roles)
                ...
                ->addColumn('action', function ($roles) {
                    return '<div style="display: inline">
                             <a href="' . route('roles.show', $this->srs->encode($roles->id)) . '" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> Show</a>
                             <a href="' . route('roles.edit', $this->srs->encode($roles->id)) . '" class="btn btn-outline-info btn-sm"><i class="fa fa-edit"></i> Edit</a>
