...
@section('content')
    <div class="container-fluid" style="margin-right: 20px; margin-left: 20px;">
        <div class="col-sm">
             <div class="box" >
                        ...
                        <ul class="products-list product-list-in-box">
                            <li class="item">
                                <div class="product-info">
                                  <b>Descriptions
                                    <a>
                                    <span class="pull-right" style="font-style: normal;margin-right: 200px">{{$instdetails->description}}</span></a>
                                  </b>
                                </div>
                            </li>
                        </ul>
                ...
                <div class="box-footer text-center">
                  <div>
                    <a href="{{route('Exam Category')}}"  class="btn btn-default btn-rounded mb-4"  style="color: #000000;"> <b>BACK</b></a>
      ...
      <form class="modal-dialog"  role=" form"  method="POST" action="{{ route('examcategory.edit',$instdetails->id) }}">
          {{ csrf_field() }} {{method_field('patch')}}
            <div class="modal-content">
              <div class="modal-header text-center">
                <h4 class="modal-title w-100 font-weight-bold">Edit Exam Category</h4>
                  ...
                  <span aria-hidden="true">&times;</span>
                    ...
                    <div class="card-body" style="padding: 20px;">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="description" name="description" value="{{$instdetails->description}}"
                                required
                                oninvalid="this.setCustomValidity('Must Enter Description')"
