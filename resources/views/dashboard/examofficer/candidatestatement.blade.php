                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <form id="admissions_candidate_statement" method="POST"
                                            action="candidate-statement">
                                            @csrf
                                            <div class="form-group" style="display: none">
                                                <label for="sel1">Choose report you want:</label>
                                                <select class="form-control" type="hidden" name="mode" required>
                                                    <option value="print_candidate_pdf" selected>Candidate Statement</option>
                                                </select>
                                            </div>
