  ...
  <?php $totalcrdt2=0; $exactcrdt2=0; $totalcrdt1=0; $exactcrdt1=0; ?>
    ...
    <div class="ibox-content">
      @if($Ayear==null)
        ...
        {{ csrf_field() }}
        <div class="form-group"><label class="col-lg-3 control-label">Select Academic Year: </label>
            <div class="col-lg-8">
               <select class="form-control" name="ayear">
                ...
                <!-- <input hidden type="text" value="{{ Auth::user()->surname }}" name="regno" class="form-control"/> -->
            </div>
        </div>
        <div class="form-group">
            <div class="col-lg-offset-3 col-lg-8">
                <input class="btn btn-sm btn-success" type="submit" value="View">
            </div>
        </div>
        </form> 
    ...
    <div class="ibox-content">
        ...
        <div class="box-footer text-center" style="margin-top:100px;">
                  <div>
                     <a href="{{route('Results')}}" class="btn btn-default btn-rounded mb-4" "  
                    style="color: #000000;">
                    <b>BACK</b></a>
