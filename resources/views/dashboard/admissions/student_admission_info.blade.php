...
{{--                                <td>Birth Date:</td><td>{{SRS::formatDob($records->dob)}}</td>--}}
                                <td>Birth Date:</td><td>{{$records->dob}}</td>
                            </tr>
                            <tr>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-unstyled">
                                            @can('admission-srs')
                                                <li>
                                                {!! Form::model($records, ['method' => 'PATCH','route' => ['admissions.update-admission-info', SRS::encode($records->user_id)]]) !!}
                                                {!! Form::hidden('status','srs') !!}
                                                {!! Form::hidden('reg_no',$records->reg_no) !!}
                                                {!! Form::hidden('user_id',$records->user_id) !!}

                                                <fieldset class="customLegend row">
                                                    <legend>
                                                        <h2 class="blue pb-0 mb-0">1. Student Reporting Status [SRS]</h2>
                                                    </legend>
                                                <span class="font-13 text-muted mt-0">Has Student Reported?</span>
                                               <div class="form-group">

                                                   <div class="icheck-primary icheck-inline">
                                                       {!! Form::radio('srs','0',null,['class'=>'form-control','id'=>'srs1']) !!}
                                                       {!! Form::label('srs1','No') !!}

                                                     </div>
                                                   <div class="icheck-primary icheck-inline">
                                                       {!! Form::radio('srs','1',null,['class'=>'form-control','id'=>'srs2']) !!}
                                                       {!! Form::label('srs2','Yes') !!}
                                                   </div>
                                                   <div class="icheck-primary icheck-inline">
                                                       {!! Form::radio('srs','2',null,['class'=>'form-control','id'=>'srs3']) !!}
                                                       {!! Form::label('srs3','Partial') !!}
                                                   </div>
                                               </div>
                                                <div class="form-group">
                                                    {!! Form::label('comment') !!}
                                                    {!! Form::text('comment', old('comment'), $errors->has('srs') ? ['placeholder' => 'Comment.','class' => 'form-control is-invalid','id'=>'comment'] : ['placeholder' => 'Comment','class' => 'form-control','id'=>'comment']) !!}

                                                </div>
                                                <div class="form-group">
                                                    {!! Form::button('Update',['type'=>'submit','class'=>'btn btn-warning pull-right']) !!}
                                                </div>
                                                </fieldset>
                                                {!! Form::close() !!}
                                            </li>
                                            @endcan
                                                ...
                                                <fieldset class="customLegend row">
                                                    <legend>
                                                        <h2 class="blue pb-0 mb-0">2. Student Payment Status [SPS]</h2>
                                                    </legend>
                                                    <div class="form-group">
                                                        <a class="pull-right" href="{{route('finances.admission-payments',SRS::encode($records->user_id))}}">Student Payments</a>
                                                    </div>
                                                    <span class="font-13 text-muted mt-0">Has Student Paid the required payments?</span>
                                                    <div class="form-group">

                                                        <div class="icheck-primary icheck-inline">
                                                            {!! Form::radio('sps','0',null,['class'=>'form-control','id'=>'sps1']) !!}
                                                            {!! Form::label('sps1','No') !!}
                                                        </div>
                                                        <div class="icheck-primary icheck-inline">
                                                            {!! Form::radio('sps','1',null,['class'=>'form-control','id'=>'sps2']) !!}
                                                            {!! Form::label('sps2','Yes') !!}
                                                        </div>
                                                        <div class="icheck-primary icheck-inline">
                                                            {!! Form::radio('sps','2',null,['class'=>'form-control','id'=>'sps3']) !!}
                                                            {!! Form::label('sps3','Partial') !!}
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        {!! Form::label('comment') !!}
                                                ...
                                                <fieldset class="customLegend row">
                                                    <legend>
                                                        <h2 class="blue pb-0 mb-0">3. Accommodation Clear Status [ACS]</h2>
                                                    </legend>

                                                    <span class="font-13 text-muted mt-0">Can Student Get Accommodation?</span>
                                                    <div class="form-group">

                                                        <div class="icheck-primary icheck-inline">
                                                            {!! Form::radio('acs','0',null,['class'=>'form-control','id'=>'acs1']) !!}
                                                            {!! Form::label('acs1','No') !!}
                                                        </div>
                                                        <div class="icheck-primary icheck-inline">
                                                            {!! Form::radio('acs','1',null,['class'=>'form-control','id'=>'acs2']) !!}
                                                            {!! Form::label('acs2','Yes') !!}
                                                        </div>
                                                        <div class="icheck-primary icheck-inline">
                                                            {!! Form::radio('acs','2',null,['class'=>'form-control','id'=>'acs3']) !!}
                                                            {!! Form::label('acs3','Partial') !!}
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        {!! Form::label('comment') !!}
                                                ...
                                                <fieldset class="customLegend row">
                                                    <legend>
                                                        <h2 class="blue pb-0 mb-0">4. Documents Verification Status [DVS]</h2>
                                                    </legend>

                                                    <span class="font-13 text-muted mt-0">Are student certificates verified?</span>
                                                    <div class="form-group">

                                                        <div class="icheck-primary icheck-inline">
                                                            {!! Form::radio('dvs','0',null,['class'=>'form-control','id'=>'dvs1']) !!}
                                                            {!! Form::label('dvs1','No') !!}
                                                        </div>
                                                        <div class="icheck-primary icheck-inline">
                                                            {!! Form::radio('dvs','1',null,['class'=>'form-control','id'=>'dvs2']) !!}
                                                            {!! Form::label('dvs2','Yes') !!}
                                                        </div>
                                                        <div class="icheck-primary icheck-inline">
                                                            {!! Form::radio('dvs','2',null,['class'=>'form-control','id'=>'dvs3']) !!}
                                                            {!! Form::label('dvs3','Partial') !!}
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        {!! Form::label('comment') !!}
                                                ...
                                                @can('admission-ras')
                                                    <li>
                                                {!! Form::model($records, ['method' => 'PATCH','route' => ['admissions.update-admission-info', SRS::encode($records->user_id)]]) !!}
                                                {!! Form::hidden('status','ras') !!}
                                                {!! Form::hidden('reg_no',$records->reg_no) !!}
                                                {!! Form::hidden('user_id',$records->user_id) !!}
                                                <fieldset class="customLegend row">
                                                    <legend>
                                                        <h2 class="blue pb-0 mb-0">5. Room Allocation Status [RAS]</h2>
                                                    </legend>

                                                    <span class="font-13 text-muted mt-0">Has Student been given a room?</span>
                                                    <div class="form-group">

                                                        <div class="icheck-primary icheck-inline">
                                                            {!! Form::radio('ras','0',null,['class'=>'form-control','id'=>'ras1']) !!}
                                                            {!! Form::label('ras1','No') !!}
                                                        </div>
                                                        <div class="icheck-primary icheck-inline">
                                                            {!! Form::radio('ras','1',null,['class'=>'form-control','id'=>'ras2']) !!}
                                                            {!! Form::label('ras2','Yes') !!}
                                                        </div>
                                                        <div class="icheck-primary icheck-inline">
                                                            {!! Form::radio('ras','2',null,['class'=>'form-control','id'=>'ras3']) !!}
                                                            {!! Form::label('ras3','Partial') !!}
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        {!! Form::label('comment') !!}
