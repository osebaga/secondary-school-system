...
<body style="border: 2px solid rgb(126, 94, 8);align-items: center;padding: 10px;">

    <table style="border:none;">
        <tr style="border:none 0px">
            <td style="border:none 0px!important; width:150px">
                <img src="{{ public_path() }}/assets/uploads/logo/logo.png" alt="" srcset="" width="150px"
                    height="150px">
            </td>
            <td style="border:none 0px!important; text-align:center;font-size:14px; line-spacing:1.5px;">
                <span style="color: rgb(126, 94, 8); font-size:1em; font-weight: bold">
            ...
            <td style="border:none 0px!important; width:150px; ">
                @if ($user->avatar)
                    <img src="{{ public_path() }}/assets/uploads/avatars/{{ $user->avatar }}" width="150px"
                        height="150px">
                @else
                    <img src="{{ public_path() }}/assets/uploads/avatars/default/profile.jpg" width="150px"
                        height="150px">
                @endif
            </td>
        </tr>
    ...
    <h1 style="text-align:center;">ACADEMIC TRANSCRIPT</h1>
    <table style="margin:auto;width: 100%;" class="table1">
        ...
        <tr>
            ...
            <th colspan="2">Total Credit Passed</th>
            <th>Sponsor</th>
        </tr>
        <tr>
            ...
            <td colspan="2">{{ $transcript->total_credits }}</td>
            <td>{{ strtoupper($student->sponsorship) }}</td>
        </tr>
    </table>
    ...
    <div class="end-transcript">
        <p style="text-align: center">|||||||||||||||||||| KEY TO GRADING ||||||||||||||||||||</p>
        <ol>
            <li>The Transcript will be valid only if it bears the institution Seal</li>
    ...
    <script type="text/php">
        if ( isset($pdf) ) {
                ...
                $pdf->page_text(35, $h-30, "PrintedX at {{date('H:m:s')}} on {{date('D d, M Y')}}", null, 12, array(0,0,0));          
            }
        </script>
</body>
