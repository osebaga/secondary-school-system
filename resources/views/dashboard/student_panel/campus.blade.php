            ...
            <div class="boxpane">
                ...
                <div class="boxpane-content">
                    <div class="row">
                        <div class="col-lg-12">
                            <p class="introtext">
                                The following is the list of school available click school name to continue
                            </p>
                            <div class="table-responsive">
                                <table id="campusTable" class="table table-bordered table-hover" style="width: 100%;">
                                    ...
                                    @foreach($institution as $inst)
                                        ...
                                        @forelse($inst->campuses as $campus)
                                            <tr>
                                                <td >
                                                    ...
                                                    {{link_to(route('student-panel.index',SRS::encode($campus->id)),$campus->campus_name)}}
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="2" class="bg-inverse white">{{"No School Data Found"}}</td>
                                            </tr>
                                        @endforelse
                                        <?php $i++?>
                                    @endforeach
