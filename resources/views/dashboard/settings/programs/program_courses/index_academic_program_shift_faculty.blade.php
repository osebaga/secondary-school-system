        ...
        <div class="col-md-12">
            <div class="boxpane">
                <div class="boxpane-header">
                    <h2 class="blue">
                        Academic Shift Programme - Colleges & Schools
                    </h2>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                <table id="collegeTable" class="table table-bordered table-hover" style="width: 100%;">
                                    <thead>
                                    <tr>
                                        <th>College Name</th> <th>Schools Name</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php $i=1;?>
                                    @foreach($college_programs as $college)
                                        <tr>
                                        ...
                                        @forelse($college->faculties as $faculty)
                                            <tr>
                                                <td >
                                                    {{link_to(route('program-shift.shift-programs',$srs->encode($faculty->id)),$faculty->faculty_name)}}
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
