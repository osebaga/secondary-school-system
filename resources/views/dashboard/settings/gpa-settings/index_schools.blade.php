...
@section('title-content')
    ...
    <title>{{ config('app.name') }} College Schools| Index</title>
                                        ...
                                        @forelse($college->faculties as $faculty)
                                            <tr>
                                                <td >
                                                    ...
                                                    {{link_to(route('gpa-settings.index',$srs->encode($faculty->id)),$faculty->faculty_name)}}
