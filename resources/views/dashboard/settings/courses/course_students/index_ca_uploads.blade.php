        ...
        <div class="boxpane">
            <div class="boxpane-header">
                <h2 class="black"><i class="fa fa-plus-circle" aria-hidden="true"></i>
                    Upload CA [Course Work Assessment] -<b class="black">{{$course->course_code}}</b>
...
{{--                        {{ Form::open(['route' => 'courses.ca-upload-store','class'=>'ca-upload','method'=>'POST','role' => 'form', 'enctype' => 'multipart/form-data'])}}--}}
                        {{ Form::open(['route' => 'ca.import','class'=>'ca-upload','method'=>'POST','role' => 'form', 'enctype' => 'multipart/form-data'])}}
