...
@section('title-content')
    ...
    <title>{{ config('app.name') }} Staff| Campus</title>
                                                ...
                                                <td>
                                                    <ul class="list-group list-group-flush">
                                                        @forelse($faculty->departments as $dep)
                                                            ...
                                                            <li class="list-group-item"> {{link_to(route('student-panel.index',SRS::encode($dep->id)),$dep->department_name)}}</li>
                                                        @empty
                                                            {{"No Departments"}}
                                                        @endforelse
                                                    </ul>
