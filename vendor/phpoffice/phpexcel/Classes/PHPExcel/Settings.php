...
class PHPExcel_Settings
{
    ...
    /**
     * Name of the class used for Zip file 
     *	e.g.
     *		ZipArchive
     *
     * @var string
    ...
    /**
     * Set the Zip handler Class that PHPExcel should use for Zip file  (PCLZip or ZipArchive)
     *
     * @param string $zipClass	The Zip handler class that PHPExcel should use for Zip file 
